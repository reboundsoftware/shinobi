...
import ch.reboundsoft.shinobi.authstore.CachedAuthStoreImpl;
...
public class ShinobiCachedModule extends AbstractModule {

    @Override
    protected void configure() {
        bind(AuthStore.class).to(CachedAuthStoreImpl.class);
